...
class V_Partido {
    private V_Equipo equipoLocal;
    private V_Equipo equipoVisitante;
    private Arbitro arbitro;
    private int golesLocal;
    private int golesVisitante;
    private int tarjetasLocal;
    private int tarjetasVisitante;
    private List<V_Jugador> jugadoresParticipantes;

    public V_Partido(V_Equipo equipoLocal, V_Equipo equipoVisitante, Arbitro arbitro, int golesLocal, int golesVisitante, int tarjetasLocal, int tarjetasVisitante) {
    ...
    public void agregarJugadorParticipante(V_Jugador jugador) {
        jugadoresParticipantes.add(jugador);
    }

    // Getters y Setters
    public V_Equipo getEquipoLocal() {
        return equipoLocal;
    }

    public V_Equipo getEquipoVisitante() {
    ...
    public List<V_Jugador> getJugadoresParticipantes() {
